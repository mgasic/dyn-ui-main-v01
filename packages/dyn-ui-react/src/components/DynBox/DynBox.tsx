...
function DynBoxInner<E extends React.ElementType = 'div'>(props: DynBoxProps<E>, ref: DynBoxRef<E>) {
  ...
  const styleVars: React.CSSProperties = {
    ...
    ...(basePadding && basePadding !== undefined ? { ['--dyn-box-padding' as any]: isToken(basePadding) ? toTokenVar(basePadding) : basePadding } : {}),
    ...
    ...(finalDirection && (direction !== undefined || flexDirection !== undefined) ? { ['--dyn-box-flex-direction' as any]: finalDirection } : {}),
    ...
    ...(gap && gap !== undefined ? { ['--dyn-box-gap' as any]: isToken(gap) ? toTokenVar(gap) : gap } : {}),
