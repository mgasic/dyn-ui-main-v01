          ...
          <div key={node.key} className={styles.node}>
            ...
            >
              ...
              {hasChildren ? (
                ...
                >
                  <DynIcon icon={isExpanded ? 'chevron-down' : 'chevron-right'} size="small" />
                </div>
              ) : (
                ...
                <div className={styles.icon} data-testid="tree-node-icon">
                  {node.icon ? (
                    typeof node.icon === 'string' ? (
                      <DynIcon icon={node.icon} size="small" />
                    ) : (
                      node.icon
                    )
                  ) : hasChildren ? (
                    <DynIcon icon="folder" size="small" />
                  ) : (
                    <DynIcon icon="file" size="small" />
                  )}
                </div>
              )}
